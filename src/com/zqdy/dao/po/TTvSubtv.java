...
/**
 * TTvSubtv entity. @author MyEclipse Persistence Tools
 */


public class TTvSubtv implements java.io.Serializable {
	// Fields
	...
	/** full constructor */
	public TTvSubtv(String name, Integer source, Integer tvId,
			TTvSnatch tvSnatch, String url, String embed, String shortSummary,
			String summary, String imageUrl, Integer volume, Integer payCount,
			Integer snatchState, Integer snatchCount, Date updateTime,
			Date addTime) {
		this.name = name;
		this.source = source;
		this.tvId = tvId;
