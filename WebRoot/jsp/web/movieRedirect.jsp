...
<body>
	...
	<div>
		<s:property value="movieEmbed.name"/><br/>
		正在为您跳转，请稍后...  
		<br/><s:property value="movieEmbed.source.name"/>
		<script>
			  window.setTimeout("window.location.href='<s:property value="movieEmbed.url"/>'",3000);
		</script>
	</div>
    <br/>
	<div class="contentBox">
