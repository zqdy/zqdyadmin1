...
<html>
		...
		<script language="javascript">	
			...
			$(document).ready(function(){
			 ...
			 var options = { 
			        ...
			        url: "<%=request.getContextPath()%>/admin/addMovie.action?t="+Math.random(),
			        type:"post" 
			    }; 
	...
	<body>
		<s:form id="movieForm" action="/admin/addMovie.action" enctype="multipart/form-data" >
			<br />
				...
				<tr>
				  <td width="123" rowspan="7" align="right">&nbsp;</td>
					<td width="123" rowspan="7" align="right">						 
						<img
							src="<%=request.getContextPath()%>/<s:property value="movie.imageUrl" />"
							height="300px">		
					</td>
					<td align="right">
						名&nbsp;称：					</td>
...
&nbsp;					</td>
				...
				<tr>
					...
					<td colspan="4" align="left">
						<table width="680px" id="embedTableId" cellspacing="0"
