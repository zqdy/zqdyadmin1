...
<html>
		...
		<script language="javascript">	
			...
			$(document).ready(function(){
			 ...
			 var options = { 
			        ...
			        url: "<%=request.getContextPath()%>/admin/doEditSubTv.action?t="+Math.random(),
			        type:"post" 
			    }; 
	...
	<body>
		<s:form id="tvForm" action="/admin/doEditSubTv.action" enctype="multipart/form-data" >
			<br />
				...
				<tr>
				  <td width="4" rowspan="7" align="right">&nbsp;</td>
					<td width="106" rowspan="7" align="right">						 
						<img
							src="<s:property value="%{getText('zqdy.imageUrl')}"/>/<s:property value="subtv.imageUrl" />"
							height="90px">		
					...
					<td height="33" align="left">
						...
						<s:hidden name="subtv.tvId"></s:hidden>
						&nbsp;
						<s:hidden name="subtv.id"></s:hidden>
